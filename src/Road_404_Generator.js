...
function Road_404_Generator({road, getTdSizeAction, playerOffsetSetterAction}) {
    let roadWithHero = [-1]
    ...
    return [
        ...
        <tr>
            <Road_404_MiddleLineGenerator road={roadWithHero} playerOffsetSetterAction={playerOffsetSetterAction}></Road_404_MiddleLineGenerator>
        </tr>,
        <tr>
